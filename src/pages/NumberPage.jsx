import React, { useState, useEffect } from 'react';
    ...
    import { ArrowLeft, Star, AlertTriangle, Palette, Heart, User, Zap, Loader2, Lock, Briefcase } from 'lucide-react';
    ...
    const NumberPage = () => {
        ...
        const handleUnlockClick = () => {
            if (!isAuthenticated) {
                ...
                // Logic for authenticated users, e.g., navigate to career page
            }
        };
        ...
        const resultInstructions = (
            <p>
                This is the detailed result for Number {numData.number}. Scroll to see all information. Use the back button to change your inputs or explore other numbers.
            </p>
        );
            ...
            <>
                ...
                >
                    <motion.div variants={sectionVariants} initial="hidden" animate="visible" className="my-4 flex justify-between items-center">
                        <Button asChild variant="ghost" className="text-purple-300 hover:text-white hover:bg-purple-500/10">
                         ...
                         <UsageInstructions instructions={resultInstructions} storageKey={`sc_help_dismissed_result_${numData.number}`} />
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-6">
                        <motion.div variants={sectionVariants} className="bg-[#1C162D] border border-purple-500/20 rounded-xl p-6 flex flex-col justify-center items-center text-center">
                            <Briefcase className="h-8 w-8 text-purple-400 mb-3" />
                            <h3 className="font-bold text-lg text-white mb-2">Career Paths</h3>
                            <Lock className="h-10 w-10 text-gray-500 my-4" />
                            <p className="text-gray-400 text-sm mb-4">Sign in to unlock your personalized career paths</p>
                            <Button onClick={handleUnlockClick} className="bg-gradient-to-r from-purple-600 to-pink-600 hover:shadow-lg hover:shadow-purple-500/20 text-white font-bold">
                                Sign In to Unlock
                            </Button>
                        </motion.div>
                ...
                <Dialog open={isAuthModalOpen} onOpenChange={setIsAuthModalOpen}>
                    <DialogContent className="bg-[#1C162D] border-purple-500/20 text-white">
                        <DialogHeader>
                            <DialogTitle className="text-center text-2xl font-bold">Unlock Your Career Paths</DialogTitle>
                            <DialogDescription className="text-center text-gray-400">
                                Please sign in or create an account to view your personalized career guidance.
                            </DialogDescription>
                        </DialogHeader>
